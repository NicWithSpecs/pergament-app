...
const FrameNode = ({ selected, dragging }: NodeProps) => {
  ...
  return (
    <div
      className={`node frame-node h-full w-full rounded-xl border-2 border-zinc-300 bg-zinc-50 p-0 shadow duration-200 ease-in-out-bounce dark:border-zinc-700 dark:bg-zinc-800 ${
